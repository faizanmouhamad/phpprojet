...
<body>
  ...
  <form action="<?php echo site_url('New_Event/index'); ?>" method="POST" id="event" >
  ...
  <div class="inner-wrap">
    <label>Equipe concernee:<br>
      <select name="nomE">
         ...
         $query=mysqli_query($conn,"SELECT nomE from Equipe");
  ...
  <br>
    <label>Date:<br>
      <input type="date" name="date" placeholder="format: yyyy-mm-jj" required></label>
  <br>
     <label>Debut:<br>
       <input type="time" name="debut"placeholder="Heure de début" required></label>
  <br>
     <label>Fin:<br>
       <input type="time" name="fin" placeholder="Heure de fin"required></label>
  <br>
    <label>Type of event:<br>
  ...
  <br>
    ...
    <textarea rows="4" cols="50" name="description" form="event" placeholder="Enter text here...">
      </textarea><br></label>
  <br>
  </div>

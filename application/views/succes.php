...
cinterval = setInterval(timeDec, 1000);
 ...
 <p style="font-size:26px;text-align:center">Vous êtes désormais un utilisateur de notre application.</p>  <p style="font-size:26px;text-align:center">Connectez-vous afin de profiter pleinement des fonctionnalités !
  </p><p style="font-size:26px;text-align:center">
